...
import type { AgentsGroupMode } from './agents-view-groups';
...
export interface CacheHintHost {
  ...
  /** Agents-view grouping preference — threaded through the `saveTuiConfig`
   *  below the same as every other persisted field (see `currentTuiConfig`). */
